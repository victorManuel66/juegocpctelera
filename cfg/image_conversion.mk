...
$(eval $(call IMG2SP, SET_PALETTE_FW  , $(PALETTE)         ))
$(eval $(call IMG2SP, CONVERT_PALETTE , $(PALETTE), g_palette ))
$(eval $(call IMG2SP, CONVERT         , src/Sprites/nave.png , 10, 6, spr, palette,))
...
$(eval $(call IMG2SP, SET_IMG_FORMAT  , sprites            ))
$(eval $(call IMG2SP, SET_OUTPUT      , c                  ))
$(eval $(call IMG2SP, CONVERT         , src/Sprites/laser.png , 2, 4, laser,,))
...
$(eval $(call IMG2SP, SET_IMG_FORMAT  , sprites            ))
$(eval $(call IMG2SP, SET_OUTPUT      , c                  ))
$(eval $(call IMG2SP, CONVERT         , src/Sprites/enemigo.png , 6, 8, enemigo,,))
$(eval $(call IMG2SP, CONVERT         , src/Sprites/EnemyExploV1/exploEnemyV1_1.png , 6, 8, explo1,,))
$(eval $(call IMG2SP, CONVERT         , src/Sprites/EnemyExploV1/exploEnemyV1_2.png , 6, 8, explo2,,))
$(eval $(call IMG2SP, CONVERT         , src/Sprites/EnemyExploV1/exploEnemyV1_3.png , 6, 8, explo3,,))
$(eval $(call IMG2SP, CONVERT         , src/Sprites/EnemyExploV1/exploEnemyV1_4.png , 6, 8, explo4,,))
$(eval $(call IMG2SP, CONVERT         , src/Sprites/EnemyExploV1/exploEnemyV1_5.png , 6, 8, explo5,,))
...
$(eval $(call IMG2SP, SET_IMG_FORMAT  , sprites            ))
$(eval $(call IMG2SP, SET_OUTPUT      , c                  ))
$(eval $(call IMG2SP, CONVERT         , src/Sprites/escenario16x8.png , 4, 4, esce,,tileset))
...
$(eval $(call IMG2SP, SET_IMG_FORMAT  , sprites            ))
$(eval $(call IMG2SP, SET_OUTPUT      , c                  ))
$(eval $(call IMG2SP, CONVERT         , src/Sprites/naveExplo/naveexplo1.png , 10, 6, playerexplo1,,))
$(eval $(call IMG2SP, CONVERT         , src/Sprites/naveExplo/naveexplo2.png , 10, 6, playerexplo2,,))
$(eval $(call IMG2SP, CONVERT         , src/Sprites/naveExplo/naveexplo3.png , 10, 6, playerexplo3,,))
$(eval $(call IMG2SP, CONVERT         , src/Sprites/naveExplo/naveexplo4.png , 10, 6, playerexplo4,,))
$(eval $(call IMG2SP, CONVERT         , src/Sprites/naveExplo/naveexplo5.png , 10, 6, playerexplo5,,))
